...
<style>
  ...
  .sb-paper-wrap{padding:16px 0 12px}.sb-paper{position:relative;max-width:620px;min-height:650px;margin:auto;padding:34px 38px 32px;border:1px solid #cfd8d4;background:#fff;color:#111;font-family:Arial,Helvetica,sans-serif;font-size:10.7px;line-height:1.55;box-shadow:0 18px 42px -30px rgba(0,0,0,.34)}.sb-draft{margin:-18px 0 16px;padding:6px;border:1px solid #e2bebe;background:#fff8f8;color:#984343;text-align:center;font-size:8.5px;font-weight:900;letter-spacing:.08em}.sb-kop{position:relative!important;display:block!important;min-height:68px;padding:3px 68px 10px;border-bottom:3px double #111;text-align:center;overflow:hidden}.sb-kop>div{display:grid;align-content:center;min-height:54px;text-align:center}.sb-kop-logo{position:absolute!important;top:50%!important;transform:translateY(-50%)!important;object-fit:contain}.sb-kop-logo.kabupaten{left:0!important;width:50px;height:54px}.sb-kop-logo.rw{right:0!important;width:52px;height:52px}.sb-kop strong{font-size:10px;line-height:1.12}.sb-kop b{font-size:11px;line-height:1.12}.sb-kop small{margin-top:2px;font-size:5.9px;line-height:1.15;white-space:nowrap}.sb-letter-title{display:grid;justify-items:center;margin:18px 0 15px}.sb-letter-title b{font-size:13.5px;text-decoration:underline}.sb-letter-title span{font-size:9px}.sb-paper p{margin:10px 0}.sb-letter-data{display:grid;grid-template-columns:145px 1fr;margin:12px 0}.sb-letter-data dt,.sb-letter-data dd{margin:0;padding:2px 0}.sb-purpose{display:grid;gap:4px;margin:13px 0;padding:9px 11px;background:#f3f6f5;border-left:3px solid #0b6b57}.sb-signatures{display:grid;grid-template-columns:1fr 1fr;gap:60px;margin-top:34px;text-align:center}.sb-signatures>div{display:grid}.sb-signatures span{font-size:8.5px}.sb-signatures b{margin-top:2px}.sb-signatures i{height:52px;border-bottom:1px solid #111}.sb-signatures small{font-size:8px}
