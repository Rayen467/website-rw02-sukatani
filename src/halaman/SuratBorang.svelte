<script>
  ...
  function cetakPreview() {
    if (!form.nama.trim() || !form.nik.trim() || !form.alamat.trim() || !form.keperluan.trim()) {
      beriTahu("Lengkapi nama, NIK, alamat, dan keperluan sebelum menyimpan PDF.");
      return;
    }
    ...
    {:else}
      <main class="sb-shell sb-main">
        ...
        <aside class="sb-preview-card">
          ...
          <div class="sb-preview-note"><span>✓</span><p><b>Cek kembali sebelum melanjutkan.</b> Pastikan nama, NIK, alamat, RT, dan keperluan sudah benar.</p></div>
...
<style>
  ...
  .sb-paper-wrap{padding:16px 0 12px}.sb-paper{position:relative;max-width:620px;min-height:650px;margin:auto;padding:34px 38px 32px;border:1px solid #cfd8d4;background:#fff;color:#111;font-family:Arial,Helvetica,sans-serif;font-size:10.7px;line-height:1.55;box-shadow:0 18px 42px -30px rgba(0,0,0,.34)}.sb-draft{margin:-18px 0 16px;padding:6px;border:1px solid #e2bebe;background:#fff8f8;color:#984343;text-align:center;font-size:8.5px;font-weight:900;letter-spacing:.08em}.sb-kop{display:grid;grid-template-columns:62px 1fr;gap:12px;align-items:center;padding-bottom:11px;border-bottom:3px double #111}.sb-logo{width:57px;height:57px;display:grid;place-items:center;border-radius:13px;background:#08715a;color:white;font:900 22px/1 Arial}.sb-kop div:last-child{display:grid;text-align:center}.sb-kop strong{font-size:13px}.sb-kop b{font-size:14px}.sb-kop small{margin-top:2px;font-size:7.4px}.sb-letter-title{display:grid;justify-items:center;margin:18px 0 15px}.sb-letter-title b{font-size:13.5px;text-decoration:underline}.sb-letter-title span{font-size:9px}.sb-paper p{margin:10px 0}.sb-letter-data{display:grid;grid-template-columns:145px 1fr;margin:12px 0}.sb-letter-data dt,.sb-letter-data dd{margin:0;padding:2px 0}.sb-purpose{display:grid;gap:4px;margin:13px 0;padding:9px 11px;background:#f3f6f5;border-left:3px solid #0b6b57}.sb-signatures{display:grid;grid-template-columns:1fr 1fr;gap:60px;margin-top:34px;text-align:center}.sb-signatures>div{display:grid}.sb-signatures span{font-size:8.5px}.sb-signatures b{margin-top:2px}.sb-signatures i{height:52px;border-bottom:1px solid #111}.sb-signatures small{font-size:8px}
