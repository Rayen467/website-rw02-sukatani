  ...
  <main class="shell kabar-main">
    ...
    <section class="agenda-layout" id="agenda">
      ...
      <aside class="mini-calendar">
        <header><a href="#/kalender" aria-label="Bulan sebelumnya">‹</a><strong>{kalenderMini.judul}</strong><a href="#/kalender" aria-label="Bulan berikutnya">›</a></header>
...
<style>
  ...
  .mini-calendar{height:162px!important;padding:10px 12px!important;border:1px solid #e1ebe7!important;border-radius:11px!important;background:#fff!important;color:#0c315a!important;box-shadow:0 5px 14px rgba(25,70,58,.045)!important;overflow:hidden!important}.mini-calendar>header{height:20px;display:flex;align-items:center;justify-content:space-between}.mini-calendar>header strong{font-size:10px;text-transform:capitalize}.mini-calendar>header>a{border:0;background:transparent;color:#0c315a;text-decoration:none;font-size:16px;line-height:1}.day-head,.date-grid{display:grid;grid-template-columns:repeat(7,1fr);gap:2px;text-align:center}.day-head span{padding:2px 0;color:#728392;font-size:6px}.date-grid span,.date-grid i{height:19px;display:grid;place-items:center;border-radius:50%;font-size:7px;font-style:normal}.date-grid span.has-event{background:#0c7561;color:#fff;font-weight:900}.date-grid span.today:not(.has-event){background:#dff5ed;color:#08705b;font-weight:900}.mini-calendar footer{height:18px;display:flex;align-items:end;gap:8px;color:#718394;font-size:6px}.mini-calendar footer span{display:flex;align-items:center;gap:3px}.dot{width:6px;height:6px;border-radius:50%}.dot.event{background:#0c7561}.dot.now{background:#bcebdd}
