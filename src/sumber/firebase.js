...
const TERJEMAHAN = [
  ...
  ["provider-email-mismatch", "Pilih akun Google dengan alamat email yang sama dengan akun website ini."],
  ["provider-already-linked", "Metode masuk tersebut sudah terhubung ke akun ini."],
  ["requires-recent-login", "Untuk perubahan keamanan ini, keluar lalu masuk kembali dan ulangi prosesnya."],
  ["requires-login", "Silakan masuk terlebih dahulu."],
  ["account-exists-with-different-credential", "Alamat email ini sudah terhubung dengan metode masuk lain. Masuk memakai metode yang sudah aktif, lalu hubungkan metode kedua dari Keamanan Akun."],
  ["credential-already-in-use", "Metode masuk ini sudah terhubung dengan akun Firebase lain. Jangan membuat akun kedua; hubungi pengelola untuk penyatuan akun."],
  ...
  ["email-already-in-use", "Email ini sudah dipakai akun Firebase lain. Masuk melalui metode akun tersebut terlebih dahulu, lalu hubungkan metode kedua dari Keamanan Akun."],
